INSERT INTO rooms(id,room_name , room_capacity , created_on , updated_on , booking_time_factor , minimum_booking_time , booking_enabled )
values ( 1, 'Amaze' , 3  ,  GETDATE() , GETDATE() , 15, 15 , 1);
INSERT INTO rooms(id,room_name , room_capacity , created_on , updated_on , booking_time_factor , minimum_booking_time , booking_enabled )
values ( 2, 'Beauty' , 7  ,  GETDATE() , GETDATE() , 15 , 15 , 1);
INSERT INTO rooms(id,room_name , room_capacity , created_on , updated_on , booking_time_factor , minimum_booking_time , booking_enabled)
values ( 3, 'Inspire' , 12  ,  GETDATE() , GETDATE() , 15 , 15 , 1);
INSERT INTO rooms(id,room_name , room_capacity , created_on , updated_on , booking_time_factor , minimum_booking_time , booking_enabled )
values ( 4, 'Strive' , 20  ,  GETDATE() , GETDATE(), 15 , 15 , 1);
